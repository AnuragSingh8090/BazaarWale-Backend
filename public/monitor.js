        ...
        return `
            <div class="log-entry ${isExpanded ? 'expanded' : ''} ${borderColorClass}" data-log-id="${logId}">
                ...
                <div class="log-details">
                    ...
                    ${log.request && log.request.cookies ? `
                        <div class="detail-section">
                            <div class="detail-title-row">
                                <div class="detail-title">🍪 Request Cookies</div>
                                <button class="copy-json-btn" onclick="copyJson(${escapeHtml(JSON.stringify(log.request.cookies))}, this)" title="Copy Cookies">
                                    <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                        <rect x="9" y="9" width="13" height="13" rx="2" ry="2"></rect>
                                        <path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"></path>
                                    </svg>
                            ...
                            <div class="json-body">${formatJson(log.request.cookies)}</div>
                        </div>
                    ` : ''}
